...
<br/><br/>
<form id="login" action="addMeetingResult.php" method="post">
    Meeting Name: <input name="meetingName" type="text" required="required" /><br/><br/>
    Apartment Name: 
    ...
    Meeting Place: <input name="meetingPlace" type="text" required="required" /><br/><br/>
    Meeting Date: 
    <select name="year">
        <?php
    ...
    Host Name: <input name="hostName" type="text" required="required" /><br/><br/>
    Meeting Abstract: <input name="meetingAbstract" type="text" required="required" /><br/><br/>
